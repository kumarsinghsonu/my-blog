...
const ThreeBoxModel =( { content, updateData, onEditingBoxChange }:PropsInterface )=>{
    ...
    const updateThirdBoxContent = ( unitData:UnitDataModel ) =>{
        updateSectionData(2,unitData)
    }
    ...
    return(
        <div className="grid grid-cols-3 gap-1">
            ...
            <div className="border hover:border-gray-500" onClick={onBoxClick(2)}>
                <BoxUnit content={content.content[2]} updateContent={ updateThirdBoxContent }></BoxUnit>
            </div>
        </div>
    )
}

export default ThreeBoxModel;